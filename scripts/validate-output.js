...
const backtestOffline = await readFile(resolve(root, 'web/data/backtest.js'), 'utf8');
const errors = [];
...
if (!backtestOffline.startsWith('globalThis.__CHIP_LOCK_BACKTEST__ = ')) errors.push('缺少離線回測資料包');
